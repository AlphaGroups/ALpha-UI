...
const Sidebar = ({ className, isCollapsed = false }: SidebarProps) => {
  ...
  const getNavigationItems = (role: UserRole): NavigationItem[] => {
    switch (role) {
      ...
      case "admin":
        return [
          { title: "College Dashboard", href: "/admin/college-dashboard", icon: LayoutDashboard },
          {
            title: "Class Management",
            href: "/admin/classes",
            icon: School,
            children: [
              { title: "My Classes", href: "/admin/classes/list", icon: BookOpen },
              { title: "Create Class", href: "/admin/classes/create", icon: Users },
              { title: "Class Templates", href: "/admin/classes/templates", icon: FileText },
            ],
          },
          {
            ...
            icon: GraduationCap,
            children: [
              { title: "Enrolled Students", href: "/admin/students/enrolled", icon: Users },
              { title: "Bulk Import", href: "/admin/students/import", icon: FileVideo },
              { title: "Student Progress", href: "/admin/students/progress", icon: BarChart3 },
            ],
          },
          {
            ...
            icon: BookOpen,
            children: [
              { title: "Assign Videos", href: "/admin/content/assign-videos", icon: Video },
              { title: "Assign Tests", href: "/admin/content/assign-tests", icon: ClipboardList },
            ],
          },
          {
            title: "Reports",
            ...
            icon: BarChart3,
            children: [
              { title: "Class Performance", href: "/admin/reports/class-performance", icon: Activity },
              { title: "Student Analytics", href: "/admin/reports/student-analytics", icon: BarChart3 },
            ],
          },
      ...
      case "class_user":
        return [
          { title: "Class Dashboard", href: "/class/dashboard", icon: LayoutDashboard },
          { title: "My Students", href: "/class/students", icon: Users, badge: "45" },
          {
            title: "Content Management",
            href: "/class/content",
            icon: BookOpen,
            children: [
              { title: "Assigned Videos", href: "/class/content/videos", icon: Video },
              { title: "Test Management", href: "/class/content/tests", icon: FileText },
              { title: "Progress Tracking", href: "/class/content/progress", icon: BarChart3 },
            ],
          },
          { title: "Student Performance", href: "/class/performance", icon: Trophy },
      ...
      case "student":
        return [
          { title: "My Dashboard", href: "/student/dashboard", icon: LayoutDashboard },
          {
            ...
            badge: "3",
            children: [
              { title: "Mathematics 101", href: "/student/classes/math-101", icon: BookOpen },
              { title: "Physics Advanced", href: "/student/classes/physics-adv", icon: BookOpen },
              { title: "Chemistry Basic", href: "/student/classes/chemistry", icon: BookOpen },
            ],
          },
          { title: "Video Library", href: "/student/videos", icon: Video },
          { title: "Test Center", href: "/student/tests", icon: FileText, badge: "2" },
  ...
  const navigationItems = user && user.role
            ...
            <CollapsibleContent className="space-y-1 px-3">
              {item.children?.map((child, index) => (
                <Link
                  key={index}
                  href={child.href}
                  className={`flex items-center px-3 py-2 text-sm rounded-md transition-colors ${isActiveLink(child.href)
